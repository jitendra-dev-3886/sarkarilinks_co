...
class MemberController extends Controller
{
    ...
    {
        $input = $request->validate(['document' => ['required', 'array:name,email,phone,location,headline,summary,experience,education,skills,template'], 'document.template' => ['required', Rule::in(['modern', 'classic', 'minimal'])], 'document.name' => ['required', 'string', 'max:150'], 'document.email' => ['nullable', 'email', 'max:255'], 'document.phone' => ['nullable', 'string', 'max:50'], 'document.location' => ['nullable', 'string', 'max:200'], 'document.headline' => ['nullable', 'string', 'max:200'], 'document.summary' => ['nullable', 'string', 'max:3000'], 'document.experience' => ['nullable', 'string', 'max:10000'], 'document.education' => ['nullable', 'string', 'max:5000'], 'document.skills' => ['nullable', 'string', 'max:3000']]);
